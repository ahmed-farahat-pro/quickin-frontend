...
// The rules themselves live in ./email-core, which has no imports so the signup
// form and `node --test` can load it too. Re-exported here because every API
// route already imports its auth helpers from this module.

export {
  checkEmail, emailProblemMessage, isDisposableEmail, isValidEmail,
  normalizeEmail, type EmailProblem,
} from './email-core'
