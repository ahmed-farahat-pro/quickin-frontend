  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', maxWidth: 820, margin: '0 auto' }}>
        ...
        <div
          aria-hidden="true"
          style={{ position: 'absolute', top: -34, left: 0, right: 0, height: 54, pointerEvents: 'none' }}
        >
          <svg
            width="100%"
            height="54"
        ...
        <p
          className="qk-reveal"
          style={{ margin: '0 0 36px', fontSize: 16, lineHeight: 1.6, color: COLORS.muted, animationDelay: '0.45s' }}
        >
